...
.end
"}
C {lab_pin.sym} 220 -250 0 0 {name=l13 sig_type=std_logic lab=vdd}
C {lab_pin.sym} 220 -50 0 0 {name=l14 sig_type=std_logic lab=vss}
C {lab_pin.sym} 170 -100 0 0 {name=l17 sig_type=std_logic lab=B}
C {lab_pin.sym} 170 -200 0 0 {name=l18 sig_type=std_logic lab=A}
C {lab_pin.sym} 300 -150 0 1 {name=l19 sig_type=std_logic lab=Z}
C {vsource.sym} -290 -450 0 0 {name=V4 value="PULSE(0 1.8 1ps 1ps 1ps .5us 1us) DC 1.8"}
C {and/and.sym} 320 -150 0 0 {name=x2}
