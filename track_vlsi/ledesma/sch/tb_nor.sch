...
C {vsource.sym} -310 430 0 0 {name=V4 value=0}
C {gnd.sym} -320 100 0 0 {name=l1 lab=GND}
C {lab_pin.sym} 30 -80 0 0 {name=l2 sig_type=std_logic lab=vdd}
...
C {lab_pin.sym} 30 100 0 0 {name=l13 sig_type=std_logic lab=vss}
...
C {lab_pin.sym} 140 0 3 1 {name=l12 sig_type=std_logic lab=out}
C {nor/nor.sym} -30 0 0 0 {name=x1}
