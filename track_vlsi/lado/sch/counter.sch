...
N -190 420 -190 430 { lab=#net1}
N -190 420 -80 420 { lab=#net1}
...
N -210 250 -160 250 { lab=#net1}
N -160 250 -160 420 { lab=#net1}
N -200 670 -200 700 { lab=q2}
N -200 670 -70 670 { lab=q2}
N -180 690 -180 700 { lab=#net2}
N -180 690 -70 690 { lab=#net2}
...
N -200 570 -140 570 { lab=#net2}
N -140 570 -140 690 { lab=#net2}
N -90 940 -60 940 { lab=q3}
N -190 840 -190 960 { lab=#net3}
N -190 960 -60 960 { lab=#net3}
...
N 30 50 110 50 { lab=#net4}
N 30 50 30 90 { lab=#net4}
...
N 40 370 120 370 { lab=#net5}
N 40 370 40 410 { lab=#net5}
...
N 50 640 130 640 { lab=#net6}
N 50 640 50 680 { lab=#net6}
...
N 60 910 140 910 { lab=#net7}
N 60 910 60 950 { lab=#net7}
...
C {dffc.sym} 270 410 0 0 {name=x3}
C {dffc.sym} 280 680 0 0 {name=x4}
C {dffc.sym} 290 950 0 0 {name=x7}
