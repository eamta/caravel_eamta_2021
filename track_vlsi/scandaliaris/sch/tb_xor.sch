...
C {vsource.sym} -135 -65 0 0 {name=V3 value="PULSE(0 \{VINA\} 300ps 10ps 10ps 0.5ns 1ns) DC\{VINA\}
"}
...
C {xor/xor.sym} 410 0 0 0 {name=XXOR1 VSS=VSS VDD=VDD}
C {vsource.sym} -130 180 0 0 {name=V4 value="PULSE(0 \{VINB\} 100ps 10ps 10ps 1ns 2ns) DC\{VINB\}
"}
