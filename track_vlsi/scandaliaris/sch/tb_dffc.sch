...
C {vsource.sym} -135 -65 0 0 {name=V3 value="PULSE(0 \{D\} 30ps 10ps 10ps 0.75ns 2.5ns) DC\{D\}
"}
...
C {lab_pin.sym} -135 -135 1 0 {name=l4 sig_type=std_logic lab=D
}
C {lab_pin.sym} 310 0 0 0 {name=l8 sig_type=std_logic lab=D
}
...
C {lab_pin.sym} 310 80 0 0 {name=l7 sig_type=std_logic lab=CLR
}
...
C {inverter/inverter.sym} 580 0 0 0 {name=XINV1 VSS=VSS VDD=VDD}
C {dffc/dffc.sym} 390 40 0 0 {name=xDFFC1 VSS=VSS VDD=VDD}
C {lab_pin.sym} 390 150 3 0 {name=l13 sig_type=std_logic lab=CLK}
