...
C {dffc_somo.sym} 570 10 0 0 {name=x2}
C {and_somo.sym} 20 160 1 0 {name=x1}
C {xor_somo.sym} 330 -200 0 0 {name=x3}
...
C {dffc_somo.sym} 570 520 0 0 {name=x4}
C {and_somo.sym} 20 670 1 0 {name=x5}
C {xor_somo.sym} 330 310 0 0 {name=x6}
...
C {dffc_somo.sym} 570 1120 0 0 {name=x7}
C {and_somo.sym} 20 1270 1 0 {name=x8}
C {xor_somo.sym} 330 910 0 0 {name=x9}
...
C {dffc_somo.sym} 570 1600 0 0 {name=x10}
C {xor_somo.sym} 330 1390 0 0 {name=x12}
