...
N 190 -290 230 -290 { lab=Q1_contador4bits}
N 190 -170 220 -170 { lab=Q0_4bitc}
N 190 -130 220 -130 { lab=Q1_4bitc}
N 190 -90 220 -90 { lab=Q2_4bitc}
N 190 -50 220 -50 { lab=Q3_4bitc}
N 190 160 220 160 { lab=b0_c4b}
...
N -220 220 -180 220 { lab=CE}
N -220 250 -180 250 { lab=CLR}
N -140 -350 -100 -350 { lab=VDD}
N -140 -330 -100 -330 { lab=CE}
N -140 -310 -100 -310 { lab=CLR}
N -140 -290 -100 -290 { lab=VSS}
N -140 -270 -100 -270 { lab=CLK}
N -150 -130 -110 -130 { lab=VDD}
N -150 -170 -110 -170 { lab=CE}
N -150 -110 -110 -110 { lab=CLR}
N -150 -150 -110 -150 { lab=VSS}
N -150 -90 -110 -90 { lab=CLK}
N -30 200 10 200 { lab=CLK}
N -30 180 10 180 { lab=CE}
...
N 710 130 710 170 { lab=VSS}
N 690 -300 690 -260 { lab=VDD}
N 710 -300 710 -260 { lab=VSS}
N 690 -720 690 -680 { lab=VDD}
N 710 -720 710 -680 { lab=VSS}
N 680 840 680 870 { lab=reg2}
N 700 840 700 870 { lab=reg1}
N 720 840 720 870 { lab=reg0}
N 680 410 680 440 { lab=reg2}
N 700 410 700 440 { lab=reg1}
N 720 410 720 440 { lab=reg0}
N 680 -440 680 -410 { lab=reg2}
N 700 -440 700 -410 { lab=reg1}
N 720 -440 720 -410 { lab=reg0}
N 780 -140 870 -140 { lab=Q1}
N 780 290 890 290 { lab=Q2}
N 780 720 890 720 { lab=Q3}
N 780 -560 860 -560 { lab=Q0}
...
C {mux_8to1_fs.sym} 760 720 0 0 {name=x5}
C {4bitc.sym} 40 -90 0 0 {name=x6}
C {c4b.sym} 100 200 0 0 {name=x7}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 220 200 0 1 {name=l1 sig_type=std_logic lab=b2_c4b}
...
C {ipin.sym} -220 190 0 0 {name=p3 lab=CLK}
C {ipin.sym} -220 220 0 0 {name=p4 lab=CE}
C {ipin.sym} -220 250 0 0 {name=p5 lab=CLR}
C {lab_wire.sym} -140 -350 0 0 {name=l45 sig_type=std_logic lab=VDD}
C {lab_wire.sym} -140 -330 0 0 {name=l46 sig_type=std_logic lab=CE}
C {lab_wire.sym} -140 -310 0 0 {name=l47 sig_type=std_logic lab=CLR}
C {lab_wire.sym} -140 -290 0 0 {name=l48 sig_type=std_logic lab=VSS}
C {lab_wire.sym} -140 -270 0 0 {name=l49 sig_type=std_logic lab=CLK}
C {lab_wire.sym} -150 -130 0 0 {name=l55 sig_type=std_logic lab=VDD}
C {lab_wire.sym} -150 -170 0 0 {name=l56 sig_type=std_logic lab=CE}
C {lab_wire.sym} -150 -110 0 0 {name=l57 sig_type=std_logic lab=CLR}
C {lab_wire.sym} -150 -150 0 0 {name=l58 sig_type=std_logic lab=VSS}
C {lab_wire.sym} -150 -90 0 0 {name=l59 sig_type=std_logic lab=CLK}
C {lab_wire.sym} -30 200 0 0 {name=l60 sig_type=std_logic lab=CLK}
C {lab_wire.sym} -30 180 0 0 {name=l61 sig_type=std_logic lab=CE}
...
C {lab_wire.sym} 710 130 1 0 {name=l53 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 690 -300 1 0 {name=l54 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 710 -300 1 0 {name=l73 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 690 -720 1 0 {name=l74 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 710 -720 1 0 {name=l75 sig_type=std_logic lab=VSS}
C {/home/eamta/skywater/xschem/xschem_library/devices/ipin.sym} 680 870 3 0 {name=p6 lab=reg2}
C {/home/eamta/skywater/xschem/xschem_library/devices/ipin.sym} 700 870 3 0 {name=p7 lab=reg1}
C {/home/eamta/skywater/xschem/xschem_library/devices/ipin.sym} 720 870 3 0 {name=p8 lab=reg0}
C {/home/eamta/skywater/xschem/xschem_library/devices/opin.sym} 860 -560 0 0 {name=p15 lab=Q0}
C {/home/eamta/skywater/xschem/xschem_library/devices/opin.sym} 870 -140 0 0 {name=p16 lab=Q1}
C {/home/eamta/skywater/xschem/xschem_library/devices/opin.sym} 890 290 0 0 {name=p17 lab=Q2}
C {/home/eamta/skywater/xschem/xschem_library/devices/opin.sym} 890 720 0 0 {name=p18 lab=Q3}
C {lab_wire.sym} 680 440 3 0 {name=l5 sig_type=std_logic lab=reg2}
C {lab_wire.sym} 700 440 3 0 {name=l6 sig_type=std_logic lab=reg1}
C {lab_wire.sym} 720 440 3 0 {name=l7 sig_type=std_logic lab=reg0}
C {lab_wire.sym} 680 10 3 0 {name=l8 sig_type=std_logic lab=reg2}
C {lab_wire.sym} 700 10 3 0 {name=l76 sig_type=std_logic lab=reg1}
C {lab_wire.sym} 720 10 3 0 {name=l77 sig_type=std_logic lab=reg0}
...
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 -160 0 0 {name=l15 sig_type=std_logic lab=D1_contador}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 -180 0 0 {name=l17 sig_type=std_logic lab=b1_c4b}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 -200 0 0 {name=l18 sig_type=std_logic lab=Q1_4bitc}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 -220 0 0 {name=l19 sig_type=std_logic lab=Q1_contador4bits}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 700 0 0 {name=l14 sig_type=std_logic lab=D3_contador}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 680 0 0 {name=l20 sig_type=std_logic lab=b3_c4b}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 660 0 0 {name=l65 sig_type=std_logic lab=Q3_4bitc}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 640 0 0 {name=l66 sig_type=std_logic lab=Q3_contador4bits}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 270 0 0 {name=l13 sig_type=std_logic lab=D2_contador}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 250 0 0 {name=l67 sig_type=std_logic lab=b2_c4b}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 230 0 0 {name=l81 sig_type=std_logic lab=Q2_4bitc}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 210 0 0 {name=l82 sig_type=std_logic lab=Q2_contador4bits}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 -580 0 0 {name=l16 sig_type=std_logic lab=D0_contador}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 -600 0 0 {name=l83 sig_type=std_logic lab=b0_c4b}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 -620 0 0 {name=l84 sig_type=std_logic lab=Q0_4bitc}
C {/home/eamta/skywater/xschem/xschem_library/devices/lab_wire.sym} 580 -640 0 0 {name=l85 sig_type=std_logic lab=Q0_contador4bits}
