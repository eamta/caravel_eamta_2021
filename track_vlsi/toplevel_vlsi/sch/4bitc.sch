...
C {and_lede.sym} 240 150 1 0 {name=x2}
C {xor_lede.sym} 350 40 0 0 {name=x3}
C {ipin.sym} 0 70 0 0 {name=p1 lab=CE}
C {opin.sym} 910 40 0 0 {name=p2 lab=Q0}
C {and_lede.sym} 220 560 1 0 {name=x5}
C {xor_lede.sym} 330 450 0 0 {name=x6}
C {opin.sym} 890 450 0 0 {name=p3 lab=Q1}
C {and_lede.sym} 200 890 1 0 {name=x8}
C {xor_lede.sym} 310 780 0 0 {name=x9}
C {opin.sym} 870 780 0 0 {name=p4 lab=Q2}
C {and_lede.sym} 180 1220 1 0 {name=x11}
C {xor_lede.sym} 290 1110 0 0 {name=x12}
