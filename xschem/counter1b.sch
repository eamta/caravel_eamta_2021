...
C {dffc_scan.sym} 190 -70 0 0 {name=xDFFC1 VSS=VSS VDD=VDD}
C {xor_scan.sym} 0 -110 0 0 {name=XXOR1 VSS=VSS VDD=VDD}
C {and_scan.sym} -160 0 1 0 {name=XAND1 VSS=VSS VDD=VDD}
