...
N 1530 -390 1590 -390 { lab=vcm}
N 1590 -620 1780 -620 { lab=vout}
N 1780 -620 1780 -410 { lab=vout}
N 1710 -410 1780 -410 { lab=vout}
N 1210 -430 1270 -430 { lab=ve}
N 1699 -410 1710 -410 { lab=vout}
N 1610 -360 1610 -300 { lab=#net1}
N 1640 -458.5 1640 -450 { lab=vdd}
N 1640 -370 1640 -351.5 { lab=vss}
...
C {isource.sym} 1610 -270 0 0 {name=I0 value=DC\{iref\}}
C {lab_pin.sym} 1610 -200 3 0 {name=l22 sig_type=std_logic lab=vss}
...
C {OpamP/opamp.sym} 1680 -410 0 0 {name=x1}
C {lab_pin.sym} 1640 -458.5 1 0 {name=l1 sig_type=std_logic lab=vdd}
C {lab_pin.sym} 1640 -351.5 3 0 {name=l4 sig_type=std_logic lab=vss}
C {launcher.sym} 970 -330 0 0 {name=h1
descr=Annotate 
tclcommand="ngspice::annotate"}
C {ngspice_probe.sym} 1537.5 -430 0 0 {name=r2}
C {ngspice_probe.sym} 1270 -430 0 0 {name=r3}
C {ngspice_probe.sym} 1090 -430 0 0 {name=r4}
C {netlist_not_shown.sym} 1070 -640 0 0 {name=SIMULATION only_toplevel=false 
...
+@M.X1.XM5.msky130_fd_pr__pfet_01v8[vdsat]
